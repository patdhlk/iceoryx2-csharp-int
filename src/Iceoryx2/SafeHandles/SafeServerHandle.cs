...
/// <summary>
/// Safe handle for server resources.
/// Ensures proper cleanup of native resources when disposed.
/// </summary>
internal sealed class SafeServerHandle : SafeIox2Handle
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SafeServerHandle"/> class.
    /// </summary>
    public SafeServerHandle() : base()
    {
    }
    ...
    /// </summary>
    public SafeServerHandle(IntPtr handle) : base(handle)
    {
    }

    /// <summary>
    /// Releases the native server handle.
    /// </summary>
